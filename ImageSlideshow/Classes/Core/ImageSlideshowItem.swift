...
open class ImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    open var spaceBetweenImages: CGFloat = 0.0
    open var imageCornerRadius: CGFloat = 0.0
    ...
    */
    init(image: InputSource, zoomEnabled: Bool, activityIndicator: ActivityIndicatorView? = nil, maximumScale: CGFloat = 2.0, spaceBetweenImages: CGFloat,
         imageCornerRadius: CGFloat) {
        self.zoomEnabled = zoomEnabled
        self.image = image
        self.activityIndicator = activityIndicator
        self.maximumScale = maximumScale
        self.spaceBetweenImages = spaceBetweenImages
    ...
    override open func layoutSubviews() {
        ...
        if !zoomEnabled {
            var newFrame = frame.size
            newFrame.width -= spaceBetweenImages
            imageView.layer.cornerRadius = imageCornerRadius
            imageView.frame.size = newFrame
        } else if !isZoomed() {
